...
// src/llm/llm-rs.ts
var llm_rs_exports = {};
__export(llm_rs_exports, {
  LLMRS: () => LLMRS
});
module.exports = __toCommonJS(llm_rs_exports);
...
var LLMRS = class {
  load(config) {
    return __async(this, null, function* () {
      ...
      this.instance = yield import_core.Llm.load(rest, enableLogging != null ? enableLogging : true);
    });
  }
  ...
  getEmbedding(params) {
    return __async(this, null, function* () {
      return yield this.instance.getWordEmbeddings(params);
    });
  }
...
//# sourceMappingURL=llm-rs.cjs.map